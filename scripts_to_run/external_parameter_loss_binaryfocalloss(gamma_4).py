...
BACKBONE = 'resnet18'
wandb.init(project='external_parameter_loss_binaryfocalloss(gamma_4)')
model_name = 'external_parameter_loss_binaryfocalloss(gamma_4)'
augment = False

loss = sm.losses.BinaryFocalLoss(gamma=4)
